...
const listItemStyle = 'box-content w-full h-full flex content-center place-content-center row-span-1 p-5 place-self-center text-white hover:text-grassGreen hover:font-semibold active:text-grassGreen active:font-semibold';

const Nav = () => {
  return (
    <nav className="grid grid-rows-5 h-screen w-full col-span-1 justify-center bg-purple">
      <div className="box-content w-full h-full flex items-center content-center place-content-center row-span-1 p-5 place-self-center text-white mb-4 mt-4">
      ...
      <ul className="row-start-2 row-end-4 grid grid-rows-5">
