...
const listItemStyle = 'font-display box-content w-full h-full flex content-center place-content-center row-span-1 p-5 place-self-center text-grey-dark border-r-2 border-grey-light hover:text-black hover:border-black hover:border-r-4 active:text-black active:border-black';

const Nav = () => {
  return (
    <nav className="grid grid-rows-4 h-screen w-full col-span-1 justify-center">
      <ul className="row-start-1 row-end-3 grid grid-rows-5">
        <li className="box-content w-full h-full flex content-center place-content-center row-span-1 p-5 place-self-center text-grey-dark border-r-2 border-grey-light">
